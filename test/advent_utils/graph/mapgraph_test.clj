...
(def t3 (mg/edgemap->MapGraph {:a {:b 7 :c 14 :d 9}
                               :b {:a 7 :d 10 :e 15}
                               :c {:a 14 :d 2 :f 9}
                               :d {:a 9 :b 10 :c 2 :e 11}
                               :e {:b 15 :d 11 :f 6}
...
(def t4 (mg/edgemap->MapGraph {:a {:j 3}
                               :b {:j 2}
                               :c {:j 4}
                               :d {:j 6}
                               :j {:a 3 :b 2 :c 4 :d 6}
...
(deftest without-vertex-test
  (testing "Can return a new graph with a vertex (and its corresponding edges) removed"
    (is (= (mg/edgemap->MapGraph {:b {:c 2}, :c {:b 2, :d 3}, :d {:c 3, :e 1}, :e {:d 1}})
           (without-vertex t1 :a)))))
...
(deftest rewired-without-vertex-test
  (testing "Can return a new graph with a vertex removed, preserving the transitive relationships"
    (is (= (mg/edgemap->MapGraph {:a {:b 5 :c 7 :d 9}
                                  :b {:a 5 :c 6 :d 8}
                                  :c {:a 7 :b 6 :d 10}
                                  :d {:a 9 :b 8 :c 10}
                                  :k {}})
